      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            ...
            <template v-if="Array.isArray(tempProduct.demoImg)" class="mb-3">
              ...
              <template v-if="!tempProduct.demoImg.length || tempProduct.demoImg[tempProduct.demoImg.length - 1]">
          ...
          <div class="col-sm-8">
            ...
            <div class="mb-3">
              <h5>遊戲特色</h5>
              <template v-if="Array.isArray(tempProduct.features)" class="mb-3">
                ...
                <template v-if="!tempProduct.features.length || tempProduct.features[tempProduct.features.length -1]">
